...
Open a reference-rule issue identifying the standard, metric, population,
measurement pathway, and exact source location.
...
Keep changes focused. Describe the motivation clearly,
